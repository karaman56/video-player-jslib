...
Этот проект с минимальным набором инструментов, который нужен для создания своего видеоплеера. Все элементы можно кастомизировать на свой вкус и цвет.
...
- [Открыть демо - проект](https://karaman56.github.io/video-player-jslib/)
